...
var map = {
	...
	"../realprofile/realprofile.module": [
		"./src/app/realprofile/realprofile.module.ts",
		"realprofile-realprofile-module"
	],
	"./addquestions/addquestions.module": [
		"./src/app/addquestions/addquestions.module.ts",
		"addquestions-addquestions-module"
	],
	"./addrecipe/addrecipe.module": [
...
__webpack_require__.r(__webpack_exports__);
var config = {
    apiKey: "AIzaSyDOMeap_AevfduoynznbqQpkh200KLxUH0",
    authDomain: "dessertrecip.firebaseapp.com",
    databaseURL: "https://dessertrecip.firebaseio.com",
    projectId: "dessertrecip",
    storageBucket: "dessertrecip.appspot.com",
    messagingSenderId: "992954427175",
    appId: "1:992954427175:web:9ef096679fe83f4b"
};
...
var UserService = /** @class */ (function () {
    function UserService(afAuth, alert, router) {
        this.afAuth = afAuth;
        this.alert = alert;
        this.router = router;
    }
    UserService.prototype.showAlert = function (header, message) {
    ...
    UserService.prototype.setRecipe = function (recipe) {
        this.recipe = recipe;
    };
    UserService.prototype.getRecipe = function () {
...
module.exports = __webpack_require__(/*! C:\Users\LiveF\Desktop\RecipeSon\DessertRecipe\src\main.ts */"./src/main.ts");
